...
void CObjMgr::Late_Update()
{
	...
	CCollisionMgr::Collision_RectEx_Base(OBJ_BOSS, OBJ_BLOCK);
	CCollisionMgr::Collision_RectEx_Base(OBJ_MONSTER, OBJ_BLOCK);
	//CCollisionMgr::Collision_RectEx_Base(OBJ_PLAYER, OBJ_BOSSBULLET);
