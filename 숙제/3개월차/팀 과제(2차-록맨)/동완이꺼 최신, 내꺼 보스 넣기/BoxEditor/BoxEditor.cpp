    ...
    _In_ int       nCmdShow)           // 창의 스타일(모양 / 최소화 또는 최대한 모양)
{
    ...
    LoadStringW(hInstance, IDC_BOXEDITOR, szWindowClass, MAX_LOADSTRING);
    ...
    HACCEL hAccelTable = LoadAccelerators(hInstance, MAKEINTRESOURCE(IDC_BOXEDITOR));
...
ATOM MyRegisterClass(HINSTANCE hInstance)
{
    ...
    // 윈도우가 사용할 아이콘 지정
    wcex.hIcon = LoadIcon(hInstance, MAKEINTRESOURCE(IDC_BOXEDITOR));
