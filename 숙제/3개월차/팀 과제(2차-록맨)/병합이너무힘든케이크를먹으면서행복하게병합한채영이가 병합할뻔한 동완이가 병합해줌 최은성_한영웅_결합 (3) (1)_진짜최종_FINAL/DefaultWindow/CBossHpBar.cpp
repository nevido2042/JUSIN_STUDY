...
void CBossHpBar::Initialize()
{
	...
	CBmpMgr::Get_Instance()->Insert_Bmp(L"../Image/Rock_Man/Hp_Bar/Cut_Hp.bmp", L"Boss_Cut_Bar");
	CBmpMgr::Get_Instance()->Insert_Bmp(L"../Image/Rock_Man/Hp_Bar/Elec_hp.bmp", L"Boss_Elec_Bar");
	CBmpMgr::Get_Instance()->Insert_Bmp(L"../Image/Rock_Man/Hp_Bar/Fire_Hp.bmp", L"Boss_Fire_Bar");
	CBmpMgr::Get_Instance()->Insert_Bmp(L"../Image/Rock_Man/Hp_Bar/Ground_Hp.bmp", L"Boss_Ground_Bar");
	CBmpMgr::Get_Instance()->Insert_Bmp(L"../Image/Rock_Man/Hp_Bar/Ice_Hp.bmp", L"Boss_Ice_Bar");
	...
	{
	case BT_ELECMAN:
		m_keyName = L"Boss_Elec_Bar";
		break;
	case BT_FIREMAN:
		m_keyName = L"Boss_Fire_Bar";
		break;
	case BT_CUTMAN:
		m_keyName = L"Boss_Cut_Bar";
		break;
	case BT_GUTSMAN:
		m_keyName = L"Boss_Ground_Bar";
		break;
	case BT_ICEMAN:
		m_keyName = L"Boss_Ice_Bar";
		break;
	case BT_END:
		break;
	default:
...
int CBossHpBar::Update()
{
	if (m_pBossMonster->GetHp() >= 80)
		...
		m_tCurHp = m_tHp_20;
	else if (m_pBossMonster->GetHp() >= 20)
		m_tCurHp = m_tHp_10;
	else if (m_pBossMonster->GetHp() >= 10)
		m_tCurHp = m_tHp_10;
	else
		m_tCurHp = m_tHp_00;
