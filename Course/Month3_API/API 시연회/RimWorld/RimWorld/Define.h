...
enum OBJID { OBJ_PROJECTILE, OBJ_ITEM, OBJ_MOUSE, OBJ_UI, OBJ_WALL, OBJ_TILE, OBJ_CAMPFIRE, OBJ_TREE, OBJ_EFFECT, OBJ_RIM, OBJ_ENEMY, OBJ_WEAPON, OBJ_GROUND, OBJ_END };

enum TILEOPT { OPT_REACHABLE, OPT_BLOCKED, OPT_END };

enum RENDERID { RENDER_BACKGROUND, RENDER_GAMEOBJECT, RENDER_WEAPON, RENDER_ITEM, RENDER_EFFECT, RENDER_INUI, RENDER_UI, RENDER_END };
...
enum CHANNELID {
    SOUND_EXPLOSION,  SOUND_EFFECT,
    SOUND_CONSTRUCT, SOUND_CONSTRUCT_WOOD, SOUND_CONSTRUCT_STEEL, SOUND_CONSTRUCT_FINISH,
    SOUND_DECONSTRUCT,
    SOUND_EVENT, SOUND_BGM, SOUND_UI, SOUND_QUEST,
    SOUND_CHARGELANCE, SOUND_BOLTACTION, SOUND_BLASTERLIGHT,
    SOUND_FLESH, SOUND_METAL,
    SOUND_TREE, SOUND_WALL, SOUND_END
};
