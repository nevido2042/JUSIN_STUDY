...
private:
	...
	_bool RayIntersectAABB(const _float3& boxMin, const _float3& boxMax, float& outDistance);
	_bool RayIntersectTriangle(const _float3& v0, const _float3& v1, const _float3& v2, _float& outDistance);
	_bool PickQuadTreeNode(class CQuadTreeNode* pNode, const _float3* pPositions, const _uint* pIndices, _float& outNearestDist, _uint& outPickedTriangleIndex);
