// 해시.cpp : 이 파일에는 'main' 함수가 포함됩니다. 거기서 프로그램 실행이 시작되고 종료됩니다.
//
...
int main()
{
    ...
    MyTable.Insert(Person3.Get_SSN(), &Person3);

    MyTable.Search(Person1.Get_SSN())->Show_Person_Info();
    MyTable.Search(Person2.Get_SSN())->Show_Person_Info();
    MyTable.Search(Person3.Get_SSN())->Show_Person_Info();
